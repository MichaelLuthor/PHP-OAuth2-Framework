...
<div class="login">
  <h1>Login</h1>
  <form method="post" action="index.php?module=Workspace&action=login">
    <input type="text" name="form[account]" placeholder="Username" required="required" />
    <input type="password" name="form[password]" placeholder="Password" required="required" />
    <button type="submit" class="btn btn-primary btn-block btn-large">Let me in.</button>
    <?php if ( null !== $loginError ): ?>
    <br>
